...
const CONTEXTS = [
  {
    ...
    questions: [
      ...
      //
      // DIAGNÓSTICO DE ENFERMAGEM NÃO É COLETADO AQUI, e isso é decisão de
      // produto, não esquecimento: o diagnóstico é registrado no sistema
      // próprio de cada hospital, em documento à parte. A Res. 736/2024 exige
      // o registro de todas as etapas no prontuário (Art. 8º) — o prontuário,
      // não necessariamente este documento. Reintroduzir é acrescentar aqui um
      // par de perguntas como o de Resultado, abaixo, e a fatia correspondente
      // em processo-enfermagem.js.
      //
