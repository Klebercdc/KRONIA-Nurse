    ...
    questions: [
      ...
      },
      {
        ...
        classify: (v) =>
          ...
          : { label: "dentro da faixa de referência", frase: `com BCF de ${v} bpm` },
      },
      {
      ...
      // ---- Sinais vitais — UMA pergunta cada, classificação se adapta à idade ----
      {
        ...
        classify: (v, answers) => {
          ...
          return { label: `dentro da faixa de referência${rotulo}`, frase: `com frequência cardíaca de ${v} bpm` };
        },
      },
      ...
      },
      {
        ...
        classify: (sist, diast, answers) => {
          ...
          if (!achado) {
            return { label: "dentro da faixa de referência", frase: `com pressão arterial de ${sist}x${diast} mmHg${notaMeta}` };
          }
      ...
      },
      {
        ...
        classify: (v, answers) => {
          ...
          return { label: `dentro da faixa de referência${rotulo}`, frase: `com frequência respiratória de ${v} irpm` };
        },
      },
      {
        ...
        classify: (v) =>
          ...
          : v < 95 ? { label: "abaixo do alvo de 95%", frase: `com SpO₂ de ${v}%, abaixo do alvo de 95%` }
          : { label: "dentro da faixa de referência", frase: `com SpO₂ de ${v}%` },
      },
      {
      ...
      },
      {
        ...
        classify: (v, answers) => {
          ...
          if (neonatal) {
            ...
            return { label: "dentro da faixa de referência", frase: `com temperatura axilar de ${v}°C` };
          }
      ...
      // ---- Pele — vocabulário muda por idade ----
      {
        ...
        options: [
          { value: "corada", label: "Corada", frase: "pele e mucosas coradas" },
          { value: "palida", label: "Pálida/descorada", frase: "pele e mucosas descoradas" },
          ...
          { value: "marmorea", label: "Moteada/marmórea", frase: "pele com aspecto marmóreo" },
        ],
      },
      {
      ...
      },
      {
        ...
        classify: (v) =>
          ...
          : { label: "dentro da faixa de referência", frase: `glicemia capilar de ${v} mg/dL` },
      },
...
const CATEGORIA_POR_ID = {
  ...
  pele_coloracao: "exame_fisico", pele_lesao_local: "exame_fisico",
