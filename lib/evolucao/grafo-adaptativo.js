...
const CONTEXTS = [
  {
    ...
    questions: [
      ...
      // Diagnóstico e Resultado são blocos obrigatórios do documento, e nada no
      // schema os alimentava: saíam sempre como "Sem registro para esta seção".
      //
      // Os dois são TEXTO LIVRE de propósito. A regra é que só vira diagnóstico
      // o que o enfermeiro nomear em palavras — oferecer uma lista de rótulos
      // (NANDA ou qualquer outra) seria o motor sugerindo diagnóstico a partir
      // de achado, exatamente o que a trava proíbe. Valor numérico continua sem
      // nenhum caminho para virar rótulo clínico.
      //
      // O "Sim/Não" antes do campo existe para separar duas coisas diferentes:
      // "não há diagnóstico a registrar" (resposta explícita do profissional) de
      // "ninguém avaliou isso" (pergunta não respondida, que vira pendência).
      {
        id: "tem_diagnostico", layer: "universal", type: "select",
        titulo: "Há diagnóstico de enfermagem a registrar?",
        options: [
      ...
      {
        id: "diagnostico_enfermagem", layer: "condicional",
        showIf: { questionId: "tem_diagnostico", equals: "sim" }, type: "texto_livre",
        titulo: "Qual o diagnóstico de enfermagem?",
        placeholder: "Ex: risco de queda; integridade da pele prejudicada",
      },
      {
...
const SUBGRUPO_POR_ID = {
  ...
  tem_diagnostico: "diagnostico", diagnostico_enfermagem: "diagnostico",
...
const CATEGORIA_POR_ID = {
  ...
  // Vão para blocos próprios do documento, não para a prosa corrida.
  tem_diagnostico: "outros", diagnostico_enfermagem: "outros",
